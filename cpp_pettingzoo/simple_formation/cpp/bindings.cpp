...
PYBIND11_MODULE(_simple_formation, m) {
  m.doc() = "Simple Formation Environment C++ Implementation";

  pybind11::class_<cpp_pettingzoo::simple_formation::SimpleFormationEnv>(
      m, "SimpleFormationEnv")
      ...
      .def("get_agents",
           &cpp_pettingzoo::simple_formation::SimpleFormationEnv::get_agents)
      .def("get_state",
           &cpp_pettingzoo::simple_formation::SimpleFormationEnv::get_state)
      .def("get_render_state",
           &cpp_pettingzoo::simple_formation::SimpleFormationEnv::get_render_state)
      .def(
          "reset",
          [](cpp_pettingzoo::simple_formation::SimpleFormationEnv& self,
