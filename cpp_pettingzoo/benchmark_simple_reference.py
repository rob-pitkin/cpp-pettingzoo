"""Benchmark C++ vs Python PettingZoo SimpleReference environments.
...
from cpp_pettingzoo.simple_reference import parallel_env as cpp_parallel_env
...
def benchmark_steps(env_factory, n_steps):
    ...
    for _ in range(n_steps):
        # SimpleReference has 2 agents
        actions = {f"agent_{i}": 1 for i in range(2)}
...
if __name__ == "__main__":
    ...
    mpe2_factory = lambda: simple_reference_v3.parallel_env(max_cycles=max_cycles, continuous_actions=False)
