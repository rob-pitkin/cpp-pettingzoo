"""Benchmark C++ vs Python PettingZoo SimpleCrypto environments."""
...
from cpp_pettingzoo.simple_crypto.simple_crypto import parallel_env as cpp_parallel_env
...
if __name__ == "__main__":
    ...
    mpe2_factory = lambda: simple_crypto_v3.parallel_env(max_cycles=MAX_CYCLES)
