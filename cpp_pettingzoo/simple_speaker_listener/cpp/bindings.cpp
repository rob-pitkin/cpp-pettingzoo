...
PYBIND11_MODULE(_simple_speaker_listener, m) {
  m.doc() = "Simple Speaker Listener Environment C++ Implementation";

  pybind11::class_<
      cpp_pettingzoo::simple_speaker_listener::SimpleSpeakerListenerEnv>(
      ...
      .def("get_agents", &cpp_pettingzoo::simple_speaker_listener::
                             SimpleSpeakerListenerEnv::get_agents)
      .def("get_state", &cpp_pettingzoo::simple_speaker_listener::
                            SimpleSpeakerListenerEnv::get_state)
      .def("get_render_state", &cpp_pettingzoo::simple_speaker_listener::
                                   SimpleSpeakerListenerEnv::get_render_state)
      .def(
          "reset",
          [](cpp_pettingzoo::simple_speaker_listener::SimpleSpeakerListenerEnv&
                 self,
